...
# Attempt(couldn't figure how to cumulate the dict vals)
# sample = input('> ').split(' ')
# wordFreq = {str(x): 0 for x in sample}
# print(wordFreq)
...
for word in line.split():
    freq[word] = freq.get(word, 0)+1  # very cool
...
# Notes: some slight updates to Python3 and a type casting of freq.keys() to
# something that .sort() works for.
